                                              ...
                                              <div class="card-body">
                                                ...
                                                <div class="tab-content">
                                                  <div class="tab-pane show active" id="activity">
                                                    <form action="{{ route(htmlspecialchars('car_user_UpdateProfile')) }}" method="POST" class="form-horizontal">
                                                      @csrf
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="inputEmail" value="{{Auth::user()->email}}" placeholder="Email">
                                                          @error('email')
                                                      ...
                                                      <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                          <input type="text" name="username" value="{{Auth::user()->username}}" class="form-control" id="inputName2" placeholder="UsernPame">
                                                        </div>
                                                      </div>
                                                      <div class="form-group row">
                                                        <label for="inputName2" class="col-sm-2 col-form-label">Contact</label>
                                                        <div class="col-sm-10">
                                                          <input type="text" name="contact" value="{{Auth::user()->contact}}" class="form-control" id="inputName2" placeholder="Your Telephone Contact">
                                                        </div>
                                                      </div>
                                          ...
                                          <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <form class="form" action="{{route('car_userImgUpdate')}}" method="post" method="post" enctype="multipart/form-data">
                                                  @csrf
