                                            ...
                                            <div class="card card-primary card-outline">
                                              <div class="card-body box-profile">
                                                ...
                                                <div class="text-center">
                                                  ...
                                                  src="{{asset('/storage/administrator/'.auth()->user()->user_image)}}">
                                                  @else
                                              ...
                                              <div class="card-body">
                                                ...
                                                <div class="tab-content">
                                                  <div class="tab-pane show active" id="activity">
                                                    <form action="{{ route(htmlspecialchars('adminUpdate')) }}" method="POST" class="form-horizontal">
                                                      @csrf
                                          ...
                                          <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <form class="form" action="{{route('AdminImgUpdate')}}" method="post" method="post" enctype="multipart/form-data">
                                                  @csrf
